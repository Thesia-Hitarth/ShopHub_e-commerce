...
const baseProducts = [
    {
        ...
        description: "Immersive over-ear headphones with clear sound, padded comfort, and all-day battery life.",
        stock: 12,
        sizes: ["Standard"],
    ...
    },
    {
        ...
        description: "A sleek smartwatch with fitness tracking, message previews, and a bright display for daily use.",
        stock: 8,
        sizes: ["40mm", "44mm"],
    ...
    },
    {
        ...
        description: "Breathable running shoes with responsive cushioning and lightweight grip for everyday miles.",
        stock: 16,
        sizes: ["7", "8", "9", "10", "11"],
    ...
    },
    {
        ...
        description: "An ergonomic aluminum stand that lifts your laptop for a cleaner desk and better posture.",
        stock: 20,
        sizes: ["Standard"],
        colors: ["Silver", "Black"],
    },
    {
        ...
        description: "Compact USB-C hub with HDMI, charging passthrough, and fast data ports for flexible setups.",
        stock: 14,
        sizes: ["6 Port", "8 Port"],
    ...
    },
    {
        ...
        description: "Tactile mechanical keyboard with solid construction, compact layout, and satisfying key feel.",
        stock: 6,
        sizes: ["75%", "Full Size"],
        colors: ["Charcoal", "Ice"],
    },
    {
        ...
        description: "Relaxed two-piece linen set designed for warm days, easy layering, and polished comfort.",
        stock: 18,
        sizes: ["S", "M", "L", "XL"],
    ...
    },
    {
        ...
        description: "Minimal ceramic diffuser with soft ambient light and quiet misting for evening reset rituals.",
        stock: 22,
        sizes: ["120 ml"],
    ...
    },
    {
        ...
        description: "Structured weekender with shoe compartment, padded straps, and enough room for quick escapes.",
        stock: 11,
        sizes: ["35L"],
    ...
    },
    {
        ...
        description: "Daily brightening serum with a lightweight finish to support glow, hydration, and smoother texture.",
        stock: 30,
        sizes: ["30 ml"],
        colors: ["Amber"],
    },
    {
        ...
        description: "Glass brewer kit with reusable mesh filter for smooth concentrate and easy morning routines.",
        stock: 15,
        sizes: ["1 Liter"],
        colors: ["Clear", "Smoke"],
    },
    {
        ...
        description: "Adjustable task lamp with warm-to-cool lighting, touch controls, and a compact weighted base.",
        stock: 13,
        sizes: ["Standard"],
    ...
    },
    {
        ...
        description: "Pocket-sized earbuds with active noise cancellation, punchy sound, and a compact charging case.",
        stock: 21,
        sizes: ["Standard"],
    ...
    },
    {
        ...
        description: "Moisture-managing training tee with a smooth handfeel and a cut built for full-range movement.",
        stock: 28,
        sizes: ["S", "M", "L", "XL"],
    ...
    },
    {
        ...
        description: "Large vegan-leather desk mat that anchors keyboards, notebooks, and a calmer workspace layout.",
        stock: 17,
        sizes: ["Medium", "Large"],
    ...
    },
    {
        ...
        description: "Relaxed utility jacket with structured pockets, lightweight insulation, and easy everyday layering.",
        stock: 12,
        sizes: ["S", "M", "L", "XL"],
    ...
    },
    {
        ...
        description: "Low-profile marble tray for candles, keys, skincare, and small objects that deserve a proper place.",
        stock: 24,
        sizes: ["Standard"],
    ...
    },
    {
        ...
        description: "Structured packing cubes and pouches that help you move from airport to hotel without the chaos.",
        stock: 19,
        sizes: ["4 Piece Set"],
    ...
    },
    {
        ...
        description: "Rich but breathable face cream designed to support the skin barrier and lock in overnight hydration.",
        stock: 32,
        sizes: ["50 ml"],
        colors: ["Cream"],
    },
    {
        ...
        description: "A balanced stainless steel chef knife that feels precise for prep work and confident in daily cooking.",
        stock: 9,
        sizes: ["8 Inch"],
        colors: ["Steel", "Walnut"],
    },
    {
        ...
        description: "Breathable mesh chair with lumbar support, adjustable tilt, and the kind of comfort long workdays need.",
        stock: 7,
        sizes: ["Standard"],
    ...
    },
    {
        ...
        description: "Soft oversized wrap that works as a travel layer, plane blanket, or quick polish for cold evenings.",
        stock: 16,
        sizes: ["One Size"],
...
function getCouponResult(code, subtotal) {
...
function filterProducts({ category, search, minPrice, maxPrice, }) {
...
app.get("/api/products", (req, res) => {
    ...
    const limit = toPositiveInt(req.query.limit, filtered.length || 12);
...
app.get("/api/categories", (_req, res) => {
    const counts = baseProducts.reduce((acc, product) => {
...
app.get("/api/categories/:slug", (req, res) => {
    ...
    const categoryName = [...new Set(baseProducts.map((product) => product.category))].find((category) => category.toLowerCase().replace(/\s+/g, "-") === slug);
    if (!categoryName) {
